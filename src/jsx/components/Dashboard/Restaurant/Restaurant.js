        ...
        <div className="col-xl-8">
          <div className="row">
                  ...
                  <div className="row">
                    <div className="col-xl-4 col-lg-4 col-6">
                      <div className="line position-relative">
                        <p className="font-w500 mb-0">Revenu total</p>
                        <h2 className="mb-0 text-primary">12,890 TND</h2>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="card">
                <div className="card-body pb-0">
                  <div className="d-flex align-items-center justify-content-between mb-2">
                    <h4 className="cate-title mb-0">Revenu total</h4>
                    ...
                    <Dropdown className="deliver-drop">
                      <Dropdown.Toggle
                        as="div"
                        className="form-control ms-0 default-select border deliver-drop-toggle style2 i-false"
                      >
                        {state}{" "}
                        <i className="fas fa-chevron-down drop-toggle-icon" />
                      </Dropdown.Toggle>
                      <Dropdown.Menu>
                        <Dropdown.Item
                  ...
                  <div className="d-flex align-items-center justify-content-between flex-wrap">
                    <div className="d-flex align-items-center flex md-nowrap flex-wrap mb-3 mb-md-0">
                      <div className="icon-bx bg-primary d-inline-block text-center me-3">
                        ...
                        >
                          <path
                            d="M20 8.5C20 4.09 16.41 0.5 12 0.5C7.58998 0.5 3.99998 4.09 3.99998 8.5C3.99998 12.91 7.58998 16.5 12 16.5C16.41 16.5 20 12.91 20 8.5ZM6.99998 8.5C6.99998 5.74 9.23997 3.5 12 3.5C14.76 3.5 17 5.74 17 8.5C17 11.26 14.76 13.5 12 13.5C9.23997 13.5 6.99998 11.26 6.99998 8.5ZM14.4 18.5H9.59998C4.35998 18.5 0.0999756 22.76 0.0999756 28C0.0999756 28.83 0.769976 29.5 1.59998 29.5H22.4C23.23 29.5 23.9 28.83 23.9 28C23.9 22.76 19.64 18.5 14.4 18.5ZM3.26998 26.5C3.94998 23.64 6.52998 21.5 9.59998 21.5H14.4C17.47 21.5 20.05 23.64 20.73 26.5H3.26998Z"
                            fill="white"
                          />
                        </svg>
                      </div>
                      <div className="me-3">
                        <p className="mb-0">Total de la commande</p>
            ...
            <div className="col-xl-12">
              <div className="card">
                <div className="card-body pb-0">
                  <h4 className="cate-title">Activité</h4>
                  <ApexBarChart />
                </div>
              </div>
            </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex align-items-center mb-4">
                    ...
                    <div>
                      <p className="font-w500 mb-0">Commande totale</p>
                  ...
                  <div className="d-flex align-items-center mb-4">
                    ...
                    <div>
                      <p className="font-w500 mb-0">Commande totale acceptée</p>
                  ...
                  <div className="d-flex align-items-center mb-4">
                    ...
                    <div>
                      <p className="font-w500 mb-0">Commande totale annulée</p>
              ...
              <div className="card">
                <div className="card-body pb-0">
                  <div className="d-flex align-items-center justify-content-between">
                    <h4 className="cate-title">Nourriture produit</h4>
                    <Dropdown>
                      ...
                      <Dropdown.Menu className="dropdown-menu" align="end">
                        <Dropdown.Item>Modfier</Dropdown.Item>
                  ...
                  <PopularPieChart />
                  {/* pie chart */}
                  <h6 className="font-w700 mb-3">Légende</h6>
